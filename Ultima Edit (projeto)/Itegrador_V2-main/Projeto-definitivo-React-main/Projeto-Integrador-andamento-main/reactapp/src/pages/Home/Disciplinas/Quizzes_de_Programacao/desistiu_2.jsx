...
export default function Desistencia_Programacao() {
  ...
  return (
    <TelaContainer>
      <Card>
        ...
        <Texto>
          Você desistiu do quiz de<strong>Programação</strong>.
        </Texto>
        <Alerta>
        ...
        <Botoes>
          <Botao onClick={() => navigate("/Home/Disciplinas/Quizzes_de_Programação")}>📘 Tentar novamente</Botao>
